 ...
 */
export type ErrorName = "FetchError" | "XSDValidatorParseError" | "XMLParseError" | "UnknownError" | "XMLValidateError" | "ParseTimeout" | "LibInitError" | "RegisteringProviderError" | "WorkerResponseTimeout" | "NotationNotValid" | "EntityNotValid";
/**
...
export type ValidationPayload = {
    ...
    onBefore?: {
        set_xml_docoument_parse_option?: number;
        set_xml_entity_notation_option?: IValidateEntityNotationOption;
        /** base uri */
        base?: string;
    };
};
...
export interface IValidateEntityNotationOption {
    ...
    notations?: {
        allowedNotation?: ParsedNotation[] | null;
        name?: boolean;
        publicId?: boolean;
        systemId?: boolean;
    };
