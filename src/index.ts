...
export { findRequiredSchemas, detectSchemaLocation, findRequiredDtds, getSchemaText, isXmlLike, resolveUri } from './util/helper';

// Jika kamu ingin mengekspor juga fungsionalitas validate secara langsung
export { validateXml, useWorker, baseUri, s1000dDocParseOption, getXmlDocumentParseOption, setXmlDocumentParseOption } from './validate';
