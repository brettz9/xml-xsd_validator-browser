...
[xml-xsd-validator-browser](../globals.md) / extractSchemaLocation

# Function: extractSchemaLocation()

> **extractSchemaLocation**(`xmlText`): [`Schema`](../type-aliases/Schema.md)[]

Defined in: [util/helper.ts:113](https://github.com/ferdisap/xml-xsd_validator-browser/blob/339c00796dd4a2c4e05b742049a9935b027659bf/src/util/helper.ts#L113)
